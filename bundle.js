...
/***/ function(module, exports, __webpack_require__) {
	...
	var GameShow = __webpack_require__(226);
	
	var routes = React.createElement(
	  Route,
	  { path: '/', component: App },
	  React.createElement(IndexRoute, { component: Home }),
	  React.createElement(Route, { path: 'game/:category', component: GameShow }),
	  React.createElement(Route, { path: 'game/:category/play', component: Game })
	);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(2);
	var GameLogic = __webpack_require__(159);
	var AnswerChoice = __webpack_require__(165);
	var Router = __webpack_require__(166).Router;
	var Route = __webpack_require__(166).Route;
	var IndexRoute = __webpack_require__(166).IndexRoute;
	var Link = __webpack_require__(166).Link;
	    ...
	    if (this.state.timeLeft !== 0) {
	      return React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            'div',
	            { className: 'flip-container', id: 'myCard' },
	            React.createElement(
	              'div',
	              { className: 'flipper' },
	              React.createElement(
	          ...
	          React.createElement(
	            ...
	            this.state.answerChoices.map(function (choice) {
	              return React.createElement(AnswerChoice, { choice: choice, correctAnswer: correct,
	          ...
	          React.createElement(
	            ...
	            React.createElement(
	              'h1',
	              { id: 'count', className: 'inline-elements' },
	              'Correct: ',
	              this.state.count
	            ),
	            React.createElement(
	  ...
	  render: function () {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        'h1',
	        null,
	        React.createElement('img', { src: imgSrc, className: 'pack-logo-very-small' }),
	        category,
	        ': ',
	        datasetName
	      ),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Spanish = __webpack_require__(160);
	var Psych = __webpack_require__(161);
	var FrenchRev = __webpack_require__(162);
	var USHistory = __webpack_require__(163);
	var Colonialism = __webpack_require__(164);
...
/***/ function(module, exports) {
	...
	module.exports = {
	  "category": "Spanish Expressions",
	  "datasetName": "Ch 6 Fill in the Blank",
	  "gameData": [
	    {
	      "definition": "En mis clases ___________ diferentes temas por medio de Internet y los peri\u00f3dicos.",
	      "term": "investigamos"
	    },
	    {
	      "definition": "Es muy importante _________ lo que est\u00e1 pasando en el mundo.",
	      "term": "estar al tanto de"
	    },
	    {
	      "definition": "Para saber algo sobre la pol\u00edtica, mi profesor sugiere que veamos _________.",
	      "term": "los noticieros"
	    },
	    {
	      "definition": "Voy a escuchar la radio esta noche porque mi ____________ favorita va a transmitir un programa sobre la situaci\u00f3n econ\u00f3mica.",
	      "term": "emisora"
	    },
	    {
	      "definition": "El locutor de este programa es muy justo; siempre explica los dos lados de cualquier tema de modo ___________.",
	      "term": "imparcial"
	    },
	    {
	      "definition": "Algunos locutores solamente explican un lado del tema por lo que me parecen _______.",
	      "term": "poco fiables"
	    }
	  ]
	}
...
/***/ function(module, exports) {
	...
	module.exports = {
	  "category": "Intro to Psychology",
	  "datasetName": "Theories and Research",
	  "gameData": [
	    {
	      "definition": "The school of psychology that views observable, measurable behavior as the appropriate subject matter for psychology ",
	      "term": "Behaviorism"
	    },
	    {
	      "definition": "The term Freud used for both his theory of personality and his therapy for the treatment of psychological disorders",
	      "term": "Psycho- analysis"
	    },
	    {
	      "definition": "The school of psychology that focuses on the uniqueness of human beings and their capacity for choice, growth, and psychological health",
	      "term": "Humanistic psychology"
	    },
	    {
	      "definition": "The scientific study of psychological characteristics that enable individuals and communities to thrive in the face of adversity",
	      "term": "Positive psychology"
	    },
	    {
	      "definition": "Mental processes such as memory, problem-solving, reasoning, decision making, perception, language, and other forms of cognition",
	      "term": "Cognitive psychology"
	    },
	    {
	      "definition": "The school of psychology that emphasizes that individuals perceive objects and patterns as whole units and that the perceived whole is more than the sum of its parts",
	      "term": "Gestalt psychology"
	    },
	    {
	      "definition": "An approach to the study of mental structures and processes that uses the computer as a model for human thinking.",
	      "term": "Information- processing theory"
	    },
	    {
	      "definition": "The school of psychology that studies how human behaviors required for survival have adapted in the face of environmental pressures ",
	      "term": "Evolutionary psychology"
	    },
	    {
	      "definition": "The view that social and cultural factors may be just as powerful as evolutionary and physiological factors in affecting behavior and mental processing ",
	      "term": "Sociocultural approach"
	    },
	    {
	      "definition": "Thorndike's rule that behaviors which have positive outcomes tend to be repeated",
	      "term": "Law of effect"
	    },
	    {
	      "definition": "The ability to learn from experience, to use information, to understand things",
	      "term": "Intelligence"
	    }
	  ]
	}
...
/***/ function(module, exports) {
	...
	module.exports = {
	  ...
	  "datasetName": "Ch 3 The French Revolution",
	  "gameData": [
	    {
	      "definition": "The clergy",
	      "term": "The First Estate "
	    },
	    {
	      "definition": "Campaign to eliminate Christian faith and practice in France undertaken by the revolutionary government.",
	      "term": "De- christianization"
	    },
	    {
	      "definition": "The commoners of France that consisted of, prosperous merchants and lawyers as well as peasants, rural agricultural workers, urban artist, and unskilled day laborers.",
	      "term": "The Third Estate"
	    },
	    {
	      "definition": "The comfortable members of the third estate, or upper middle class. Rose up to lead the entire third estate in the revolution.",
	      "term": "The bourgeoisie"
	    },
	    {
	      "definition": "The fear of noble reprisals against peasant uprisings that seized the French countryside and led to further revolt.",
	      "term": "The Great Fear"
	    },
	    {
	      "definition": "The laboring poor of Paris, so called because the men wore trousers instead of the knee breaches of the aristocracy and middle class; the word came to refer to the militant radicals of the city.",
	      "term": "sans- culottes"
	    },
	    {
	      "definition": "The period from 1793 to 1794 during which Robespierre's Committee of Public Safety tried and executed thousands suspected of treason and new revolutionary culture was imposed.",
	      "term": "Reign of Terror"
	    },
	    {
	      "definition": "The nobility or the descendants of \"those who fought\" in the Middle Ages.",
	      "term": "The Second Estate"
	    }
	  ]
	}
...
/***/ function(module, exports) {
	...
	module.exports = {
	  "category": "101A. US History",
	  "datasetName": "American Revolution",
	  "gameData": [
	    {
	      "definition": "A congress convened by British officials in 1754 promoting a unification of British colonies in North America for security and defense against the French.",
	      "term": "Albany Congress"
	    },
	    {
	      "definition": "Two battles, fought on April 19, 1775, that opened the Revolutionary War.",
	      "term": "Battle of Lexington and Concord"
	    },
	    {
	      "definition": "A 1777 British defeat . Major turning point in Revolutionary War. Defeat convinced French to ally with the US against Britain.",
	      "term": "Battle of Saratoga"
	    },
	    {
	      "definition": "On March 5, 1770,  a mob of angry Bostonians began throwing rocks and sticks at the British troops who were occupying the city.",
	      "term": "Boston Massacre"
	    },
	    {
	      "definition": "On December 16, 1773, a band of Bostonians disguised themselves as Native Americans and destroyed chests of tea aboard ships in the harbor.",
	      "term": "Boston Tea Party"
	    },
	    {
	      "definition": "A meeting convened in 1774 for delegates from twelve of the thirteen colonies (Georgia abstained) in order to protest the Intolerable Acts.",
	      "term": "First Continental Congress"
	    },
	    {
	      "definition": "A war waged in North America among the major European powers in mid 1700s. Part of Seven Years war.",
	      "term": "French and Indian War"
	    },
	    {
	      "definition": "Those who chose to support Britain during the Revolutionary War.",
	      "term": "Loyalists"
	    },
	    {
	      "definition": "An economic theory predominant in the 1700s that held that nations should amass wealth to increase their power.",
	      "term": "Mercantilism"
	    }
	  ]
	}
...
/***/ function(module, exports) {
	...
	module.exports = {
	  ...
	  "gameData": [
	    ...
	    {
	      "definition": "The process of moving and living in such a place.",
	      "term": "Settlement"
	    },
	    {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AnswerChoice = React.createClass({
	  ...
	  render: function () {
	    return React.createElement(
	      "div",
	      { className: "answer", onClick: this.handleClick, id: this.props.choice },
	      React.createElement(
	        "div",
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            Link,
	            { to: 'game/spanish' },
	            React.createElement('img', { src: './images/spanish.jpg', className: 'pack-logo' }),
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            Link,
	            { to: 'game/psych' },
	            React.createElement('img', { src: './images/psych.jpg', className: 'pack-logo' }),
	            React.createElement('br', null),
	            'Psychology'
	          )
	        ),
	        React.createElement(
	          ...
	          React.createElement(
	            Link,
	            { to: 'game/ushistory' },
	            React.createElement('img', { src: './images/ushistory.jpg', className: 'pack-logo' }),
	            React.createElement('br', null),
	            'US History'
	          )
	        ),
	        React.createElement(
	          ...
	          React.createElement(
	            Link,
	            { to: 'game/colonialism' },
	            React.createElement('img', { src: './images/colonialism.jpg', className: 'pack-logo' }),
	            React.createElement('br', null),
	            'Colonialism'
	          )
	        ),
	        React.createElement(
	          ...
	          React.createElement(
	            Link,
	            { to: 'game/frenchrev' },
	            React.createElement('img', { src: './images/frenchrev.jpg', className: 'pack-logo' }),
	            React.createElement('br', null),
	...
	var GameShow = React.createClass({
	  ...
	  render: function () {
	    ...
	    return React.createElement(
	      'div',
	      null,
	      React.createElement('img', { src: imgSrc, className: 'pack-logo-small' }),
	      React.createElement(
	        'h1',
	        null,
	        displayCategory
	      ...
	      React.createElement(
	        'h4',
	        null,
	        "Or go back to choose a different set of questions"
	      ),
	      React.createElement(
	        Link,
	        { to: '/' },
